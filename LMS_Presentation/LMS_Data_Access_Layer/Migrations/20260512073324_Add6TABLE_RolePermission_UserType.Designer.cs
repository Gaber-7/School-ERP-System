...
namespace LMS_Data_Access_Layer.Migrations
{
    ...
    [Migration("20260512073324_Add6TABLE_RolePermission_UserType")]
    partial class Add6TABLE_RolePermission_UserType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.EmployeeAttachment", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.HR.LeaveRequest", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Learning_Management_System.GradeSupervisor", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Learning_Management_System.SubjectSupervisor", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Administration.Floor", b =>
                {
                    ...
                    b.HasOne("LMS_Data_Access_Layer.Models.Employee", "floorMonitor")
                        .WithMany("Floors")
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Employee", b =>
                {
                    ...
                    b.HasOne("LMS_Data_Access_Layer.Models.Employee", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.EmployeeAttachment", b =>
                {
                    ...
                    b.HasOne("LMS_Data_Access_Layer.Models.Employee", "Employee")
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Learning_Management_System.SubjectSupervisor", b =>
                {
                    ...
                    b.HasOne("LMS_Data_Access_Layer.Models.Learning_Management_System.Subject", "Subject")
                        .WithMany("SubjectSupervisors")
            ...
            modelBuilder.Entity("LMS_Data_Access_Layer.Models.Page", b =>
                {
                    b.HasOne("LMS_Data_Access_Layer.Models.Page", "Parent")
                        .WithMany("ChildPages")
